...
class Mycal_model extends CI_Model {
	...
	public function calendar_template()
	{
		...
		{cal_row_start}<tr class="days">{/cal_row_start}
		{cal_cell_start}<td>{/cal_cell_start}
		{cal_cell_start_today}<td class="fw-bold">{/cal_cell_start_today}
		{cal_cell_start_other}<td class="other-month">{/cal_cell_start_other}
	
		{cal_cell_content}
			<div class="day_num">{day}</div>
			<div class="content bg-primary text-light fw-semibold rounded p-1" data-bs-toggle="modal" data-bs-target="#offDay{day}">{content}</div>
		{/cal_cell_content}
		{cal_cell_content_today}
		<div class="">
			<div class="highlight">{day}</div>
			<div class="content bg-primary text-light fw-semibold rounded p-1">{content}</div>
		</div>
		{/cal_cell_content_today}
