<div class="card-body border border-top-0 mb-2">
   <div class="row mb-4">
      <h4 class="fw-bold"><i class="fa-solid fa-gear"></i> Update Teacher Info</h4>
   </div>
   <hr>
   <?php foreach($teacher as $i): ?>
   <?= form_open('Admin/update_teacher/'.$i->userID)?>
   <div class="row g-3">
      <div class="col-sm-4">
      ...
      <!-- <div class="col-sm-6">
         ...
         <input type="email" name="email" value="<?php if(isset($email)){ echo $email;}else{echo $i->email;}?>" class="form-control <?= (form_error('email')) ? 'is-invalid' : ''?>" placeholder="you@email.com">
         <div class="invalid-feedback">
   ...
   <div class="row g-3">
      ...
      <div class="col-sm-4">
         <?= form_open('Admin/update_teacher_email/'.$i->userID)?>
      ...
      <div class="col-sm-6">
         <?= form_open('Admin/update_teacher_password/'.$i->userID)?>
