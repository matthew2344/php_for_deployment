                  ...
                  <table class="table">
                     ...
                     <?php foreach($staffs as $i):?>
                        <tr>
                           ...
                           <td>
                              <a href="<?=base_url('View_staff/'.$i->userID)?>" class="btn"><i class="material-icons">search</i></a>
                              <a href="<?=base_url('Edit_staff/'.$i->userID)?>" class="btn"><i class="material-icons">edit</i></a> 
...
<div class="modal fade" id="exampleModal<?=$i->userID?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <?=form_open("Admin/staff_student/$i->userID")?>
