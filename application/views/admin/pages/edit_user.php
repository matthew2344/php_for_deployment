<div class="card-body border border-top-0 mb-2">
   <div class="row mb-4">
      <h4 class="fw-bold"><i class="fa-solid fa-gear"></i> Update Admin Info</h4>
   </div>
   <hr>
   <?php foreach($admin as $i): ?>
   <?= form_open($form_update.'/'.$i->userID)?>
   <div class="row g-3">
      <div class="col-sm-4">
   ...
   <div class="row g-3">
      ...
      <div class="col-sm-5">
         <?=form_open('Admin/update_admin_email/'.$i->userID)?>
      ...
      <div class="col-sm-6">
         <?=form_open('Admin/update_admin_password/'.$i->userID)?>
