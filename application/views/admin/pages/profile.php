         ...
         <div class="card-body">
            <div class="row">
               <div class="col-xl-3 col-lg-4 col-md-12">
                  <button class="btn rounded-circle" style="width: 100%;" data-bs-toggle="modal" data-bs-target="#exampleModal">
                  <?php if(isset($_SESSION['avatar'])):?>
                     <img class="rounded-circle" src="<?=base_url($this->config->item('Upload_img'))?><?=$_SESSION['avatar']?>" alt="" height="200" style="width: inherit; object-fit: contain; display: block;">
                  <?php else:?>     
